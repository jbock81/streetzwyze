                ...
                <div class="row">
                    <div class="col-lg-8">
                        <ul class="articles">
                            <li>
                                ...
                                <a href="single-blog.php" class="btn btn-danger">Read More</a>
                            </li>
                            <li>
                                <a href="#"><img src="//placehold.it/1000x500" class="img-fluid"></a>
                                <h4><a href="#">Post Title</a></h4>
                    ...
                    <div class="col-lg-4">
                        <aside id="sidebar" class="sidebar">
                            <div class="widget">
                                <img src="//placehold.it/300x600" class="img-fluid d-none d-lg-block d-sm-block mx-auto">
                                <img src="//placehold.it/720x90" class="img-fluid d-lg-none d-sm-none d-none mx-auto">
                            </div>
                        </aside>
                    </div>
                </div>
