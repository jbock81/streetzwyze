                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <div class="table-responsive">
                                                <table id="orders_tbl" class="table table-striped table-bordered" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                            <th>Order Tag</th>
                                                    ...
                                                    <tbody id="orders_body">
                                                        ...
                                                        <tr>
                                                            <td>Haley Kennedy</td>
                                                            <td class="d-none d-lg-table-cell">Senior Marketing Designer</td>
                                                            <td>43</td>
...
<script type="text/javascript">
    ...
    function get_orders(ddate_from, ddate_to)
    {
        $.post(
            "admin-seller/ajax/getorders.php",
            {
            ...
            function(data){
                ...
                if (data != "[[]]")
                {
                    for (var i=0; i<obj_data.length; i++)
                    {
                        ...
                        str_body += '<td><span class="badge badge-warning text-white">' + obj_data[i]["Status"] + '</td>';
                        str_body += '<td class="d-none d-lg-table-cell">' + obj_data[i]["Reservedate"] + '</td></tr>';
                    }
                }
                $("#orders_body").html(str_body);
            }
        );
    ...
    $(document).ready(function() {
        ...
        get_orders(ddate_from, ddate_to);
