                ...
                <div class="row">
                    <div class="col-lg-8">
                        <article class="article">
                            <a href="#"><img src="//placehold.it/1000x500" class="img-fluid"></a>
                            <h4><a href="#">Post Title</a></h4>
                            <p class="text-danger">Posted on May 19, 2020</p>
                            ...
                            <div class="share-post">
                                <p>Share Post on:</p>
                                <a href="#"><img src="https://staging.streetzwyze.com/img/st-facebook.png"></a>
                                <a href="#"><img src="https://staging.streetzwyze.com/img/st-whatsapp.png"></a>
                                <a href="#"><img src="https://staging.streetzwyze.com/img/st-twitter.png"></a>
                            </div>
                        </article>
                    </div>
                    <div class="col-lg-4">
                        <aside id="sidebar" class="sidebar">
                            <div class="widget">
                                <img src="//placehold.it/300x600" class="img-fluid d-none d-lg-block d-sm-block">
                                <img src="//placehold.it/720x90" class="img-fluid d-lg-none d-sm-none d-none">
                            </div>
                        </aside>
                    </div>
                </div>
