<?php /* Smarty version 3.1.27, created on 2020-03-02 12:51:52
         compiled from "/home2/l3n9m1k1/streetz/widget/application/views/main/gateway.test-payment.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:21068231335e5cf3583686a7_61952738%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6bfe2956dca59ced3425e668c2aeac7578349590' => 
    array (
      0 => '/home2/l3n9m1k1/streetz/widget/application/views/main/gateway.test-payment.tpl',
      1 => 1583149499,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '21068231335e5cf3583686a7_61952738',
  'variables' => 
  array (
    'page_title' => 0,
    'reservation' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_5e5cf3583c6748_52088925',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_5e5cf3583c6748_52088925')) {
function content_5e5cf3583c6748_52088925 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '21068231335e5cf3583686a7_61952738';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
...
favicon.png" alt="logo"/>
                                                    ...
                                                    <div class="amount-txt">
                                                        ...
                                                        <p class="big-amount-txt" data-reservation-id="<?php echo $_smarty_tpl->tpl_vars['reservation']->value['id'];?>
">₦<?php echo $_smarty_tpl->tpl_vars['reservation']->value['order_amount'];?>
</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="Cc" name="card-number" maxlength="16" data-validate="required" data-validateError="Fill in your card number" data-pattern="^\d{16}$" data-patternError="Card number is incorrect">
                                                    <div class="card-type-container">
                                                        <img id="card-type-container-img" data-src="<?php echo SmartyMiscFunctions::smartyFunctionAssetsUrl(array(),$_smarty_tpl);?>
img/" data-cardType="" src="">
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" id="Cvv" name="cc-cvv" maxlength="3" data-validate="required" data-validateError="Invalid CVV" data-pattern="^\d{3}$" data-patternError="Invalid CVV">
                                                    <span class="error"></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control text-align-center" id="Pin" name="cc-pin" maxlength="4" readonly data-validate="required" data-validateError="Invalid Pin" data-pattern="^\d{4}$" data-patternError="Invalid Pin">
                                                    <span class="error"></span>
                                                </div>
                                            </div>
                                        </div>
